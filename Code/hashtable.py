...
class HashTable(object):
    ...
    def keys(self):
        ...
        Running time: O(n) in worst case (if all keys are in one bucket), O(1) in average case"""
    ...
    def contains(self, key):
        ...
        Running time: O(1) on average, O(n) in worst case (if all keys are in one bucket)"""
